 ...
 */
?>
<div class="searchbar-wrap msr-site-search">
	...
	<form role="search" method="get" id="searchform" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		<div class="input-group">
			...
			<input class="form-control" type="search" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" id="s" placeholder="<?php echo esc_attr( msrproducts_get_catalog_search_placeholder() ); ?>" list="catalog-search-suggestions" autocomplete="off" />
